...
//       setLoading(true);
//       const response = await axios.get("http://192.168.137.1:5000/project/companies");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://192.168.137.1:5000/project/projects-with-sites");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://192.168.137.1:5000/material/work-descriptions", {
//         params: { site_id },
//       });
