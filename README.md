...
//       setLoading(true);
//       const response = await axios.get("http://ip/project/companies");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://ip/project/projects-with-sites");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://ip/material/work-descriptions", {
//         params: { site_id },
//       });
...
//       `http://ip/site-incharge/material-usage-details?material_ack_id=${ackId}&date=${selectedDate}`
//     );
...
//         try {
//           const response = await axios.get(
//             `http://ip/material/dispatch-details/?pd_id=${selectedProject.project_id}&site_id=${selectedSite.site_id}&desc_id=${selectedWorkDescription.desc_id}`
//           );
...
//             axios.get(
//               `http://ip/site-incharge/acknowledgement-details?material_dispatch_id=${dispatch.id}`
//             ).catch(err => ({ data: { data: [] } }))
//           );
...
//     try {
//       const response = await axios.post("http://ip/site-incharge/acknowledge-material", {
...
//         `http://ip/site-incharge/acknowledgement-details?material_dispatch_id=${dispatchId}`
//       );
//       setAckDetails(prev => ({
//         ...prev,
...
// //     const response = await axios.post("http://ip/site-incharge/save-material-usage", {
