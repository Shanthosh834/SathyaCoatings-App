...
//       setLoading(true);
//       const response = await axios.get("http://10.252.71.28:5000/project/companies");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://10.252.71.28:5000/project/projects-with-sites");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://10.252.71.28:5000/material/work-descriptions", {
//         params: { site_id },
//       });
...
//       `http://10.252.71.28:5000/site-incharge/material-usage-details?material_ack_id=${ackId}&date=${selectedDate}`
//     );
...
//         try {
//           const response = await axios.get(
//             `http://10.252.71.28:5000/material/dispatch-details/?pd_id=${selectedProject.project_id}&site_id=${selectedSite.site_id}&desc_id=${selectedWorkDescription.desc_id}`
//           );
...
//             axios.get(
//               `http://10.252.71.28:5000/site-incharge/acknowledgement-details?material_dispatch_id=${dispatch.id}`
//             ).catch(err => ({ data: { data: [] } }))
//           );
...
//     try {
//       const response = await axios.post("http://10.252.71.28:5000/site-incharge/acknowledge-material", {
...
//         `http://10.252.71.28:5000/site-incharge/acknowledgement-details?material_dispatch_id=${dispatchId}`
//       );
//       setAckDetails(prev => ({
//         ...prev,
...
// //     const response = await axios.post("http://10.252.71.28:5000/site-incharge/save-material-usage", {
