...
//       setLoading(true);
//       const response = await axios.get("http://10.140.205.28:5000/project/companies");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://10.140.205.28:5000/project/projects-with-sites");
...
//       //if  fetch works correctly loading states will display
//       setLoading(true);
//       const response = await axios.get("http://10.140.205.28:5000/material/work-descriptions", {
//         params: { site_id },
//       });
